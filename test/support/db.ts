...
create table ZROUTINE (Z_PK integer primary key, ZNAME text, ZSOFTDELETED integer, ZUPNEXT integer, ZPERIOD integer, ZWORKOUTPLAN integer, Z_FOK_PERIOD integer);
...
create table ZEXERCISECONFIGURATION (Z_PK integer primary key, ZINFORMATION integer, ZREPS integer, ZSETS integer, ZWEIGHT real, ZTIME integer, ZUSEINDIVIDUALSETS integer);
...
create table ZEXERCISERESULT (Z_PK integer primary key, ZWORKOUT integer, ZCONFIGURATION integer, ZEXERCISE integer, Z_FOK_WORKOUT integer);
...
insert into ZEXERCISECONFIGURATION values (2000, 1000, 5, 3, 100, null, 1);
insert into ZEXERCISECONFIGURATION values (2001, 1001, 5, 3, 80, null, 0);
insert into ZEXERCISECONFIGURATION values (2002, 1001, 8, 2, 82.5, 120, 0);
insert into ZEXERCISECONFIGURATION values (2003, null, 5, 3, 90, null, 0);
insert into ZEXERCISECONFIGURATION values (2004, 1001, 8, 2, 22.7272727273, null, 1);
...
insert into Z_12ROUTINES values (2004, 101, 200);
...
insert into ZSETCONFIGURATION values (3004, 2004, 3, 5, 20.4545454545, null, null);
insert into ZSETCONFIGURATION values (3005, 2004, 0, 8, 22.7272727273, null, null);
insert into ZSETCONFIGURATION values (3006, 2004, 1, 8, 22.7272727273, null, null);
...
insert into ZEXERCISERESULT values (5000, 4000, 2000, 1000, 200);
insert into ZEXERCISERESULT values (5002, 4000, 2001, 1001, 100);
insert into ZEXERCISERESULT values (5001, 4001, 2000, 1000, 100);
insert into ZEXERCISERESULT values (5003, 4001, 2003, 1001, 200);
insert into ZEXERCISERESULT values (5004, 4001, 2000, 1002, 300);
